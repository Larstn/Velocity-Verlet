E_x = zeros(579,1381,2);
E_y = zeros(579,1381,2);
E_z = zeros(579,1381,2);
...
n_masses = 100;
KE = 125;
electron_mass       = 1.66e-27;%1.6605e-27;
...
[dGdEx_sum, dGdEy_sum, dGdEz_sum, G_sum, xv_all_old, DG, xv_dual, Nt] ...
...
hold on 
for i = 1:11
    plot3(xv_all_old(ix_x,i), xv_all_old(ix_y,i), xv_all_old(ix_z,i))
end
...
for i = 1:11
    plot(xv_all_old(ix_y(1:end),i), xv_all_old(ix_x(1:end),i),'ro')

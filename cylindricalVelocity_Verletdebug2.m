classdef cylindricalVelocity_Verletdebug2
    properties
        xyz
        resolution
    ...
    methods        
        ...
        function obj = cylindricalVelocity_Verletdebug2(xyz, resolution, ParticleArray, Fobj,varargin)
%% Inputs: Dimensions, Resolutions, Array of Particles, Function Handle Objective Function, E_fields (3) or Potential (1)
        ...
        function obj = calculateF_dF(obj)
                ...
                obj.DG = zeros(obj.ParticleArray(1).Nt*6,length(obj.ParticleArray));
            tt = tic;
            for ii = 1:length(obj.ParticleArray)
                ...
                obj.S_p{ii} = S_p;
                obj.systemMatrix{ii} = systemMatrix;
                obj.accelMatrix{ii} = accelMatrix;

                obj.ParticleArray(1,ii).xv_dual = S_p' \ DG;
                
                [obj, dGdEx, dGdEr, dGdEz, ~] = obj.getdGdE(ii, accelMatrix, ix_x, ix_y, ix_z, accelInterpMatrix);
...
%
        ...
        function [obj, S_p] = get_PrimalS(obj, Ix, Iy, Iz, ii, systemMatrix)
...
% derivation with respect to the electric field).
        ...
        function [obj, dGdEx, dGdEy, dGdEz, dGda] = getdGdE(obj, ii, accelMatrix, ...
